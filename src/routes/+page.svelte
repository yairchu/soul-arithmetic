	...
	let questions = shuffle([
		...
		},
		{
			...
			origin_info: html`
				...
				<p>
					"There will be competition and conflict everywhere. So long as the points of contact are
					still comparatively few, as is the case now, friction and conflict will be few and less
					evident. The more this intermixing develops, however, the stronger the conflict will
					become."
				</p>
			`,
			alt_answers: [
		...
		},
		{
			...
			origin_info: html`
				<p>
					Rabbi Ovadia Yosef
					<a
						href="https://www.jpost.com/jewish-world/jewish-news/rabbi-ovadia-women-should-stick-to-cooking-sewing"
					>
						has said</a
					>
